...
<?php print $containerstart; ?>
  ...
  <main class="container non-clf <?php if (!$is_front): print ' contentwrapper-node-'; ?><?php if (isset($node)): print $node->nid; endif; ?><?php endif; ?>">
    <div id="content" class="row<?php if (!$is_front): ?> maincontent-node-<?php if (isset($node)): print $node->nid; endif; ?><?php endif; ?>" role="main">
      
      
      <div class="region-main <?php print _sparc_content_span($columns); ?>">  
      ...
      <aside class="col-md-3 region-sidebar-second" role="complementary">
